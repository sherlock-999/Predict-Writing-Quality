"""
Inference: Predict Essay Scores — Kaggle Submission (v4 features)
==================================================================
...
as tfidf_svd.pkl (see precompute_features.py).  It is loaded from
MODELS_DIR at inference time so train and test use the same transformer.

Paths (Kaggle notebook environment):
    DATA_DIR   = /kaggle/input/competitions/linking-writing-processes-to-writing-quality
    MODELS_DIR = /kaggle/input/datasets/sherlocked999/writing-quality-lightgbm-v4
...
# =============================================================================
# FEATURE COLUMNS  (v4 — 169 features)
# =============================================================================
